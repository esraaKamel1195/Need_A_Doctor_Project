		...
		<div class="container">
					  ...
					  <div class="container-fluid nav-bar">
					   ...
					   <div class="navbar-header">
					    ...
					    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  ...
						  <li class="dropdown"><a href="<?php echo base_url() ; ?>need_doctor/form_patient" style="color:#337ab7;">What do you feel? <span class="glyphicon glyphicon-log-in"></span></a>
          <div class="dropdown-menu">
            <form id="formLogin" class="form container-fluid" style="width:400px;height:400px;">
              ...
              <button type="button" id="btnLogin" class="btn btn-block"onclick="" style="margin-top:100px;background-color:#3a9ecb;" >Search</button>
            </form>
					        ...
					        <li><a class="menu" href="<?php echo base_url() ; ?>need_doctor/index/#service"><font size="2 px">our services</font> </a></li>
					       <!-- <li><a class="menu" href="#team">our team</a></li>-->
					       <li><a class="menu" href="<?php echo base_url() ; ?>need_doctor/index/#contact"> <font size="2 px">contact us</font></a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2 single-member col-sm-4">
					...
					<div class="person-detail"  style="height:250px;width:200px;">
